...
def intro(fenster, breite, hoehe):
    ...
    schrift_titel = pygame.font.SysFont("Comic Sans MS", max(50, breite // 10))

    titel = schrift_titel.render("Magi: die Versammlung", True, (255, 215, 0))
    titel_x = breite // 2 - titel.get_width() // 2
    titel_y = hoehe // 2 - 50
    ...
    for alpha in range(0, 256, 4):
        ...
        titel.set_alpha(alpha)
        text.set_alpha(alpha)
        fenster.blit(titel, (titel_x, titel_y))
